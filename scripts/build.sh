...
OUTPUT_APP_DIR="$PROJECT_ROOT/outputs/DockGesture-1.0.2.app"
ZIP_PATH="$PROJECT_ROOT/outputs/DockGesture-1.0.2.zip"
...
(
    ...
    /usr/bin/zip -qryX "DockGesture-1.0.2.zip" "DockGesture-1.0.2.app"
)
