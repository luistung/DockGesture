...
OUTPUT_APP_DIR="$PROJECT_ROOT/outputs/DockGesture-1.0.1.app"
ZIP_PATH="$PROJECT_ROOT/outputs/DockGesture-1.0.1.zip"
...
(
    ...
    /usr/bin/zip -qryX "DockGesture-1.0.1.zip" "DockGesture-1.0.1.app"
)
