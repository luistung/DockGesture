...
当前修订版应用位于 `outputs/DockGesture-1.0.3.app`，便于传递的压缩包位于 `outputs/DockGesture-1.0.3.zip`。1.0.3 修复了覆盖旧版本后 macOS 仍显示默认占位图标的问题。建议先把应用移动到“应用程序”文件夹，再首次打开；授予权限后不要再移动应用，否则 macOS 可能要求重新授权。
